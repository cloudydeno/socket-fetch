...
import { AutoDialer, type Dialer } from "./dialers.ts";
...
export const fetch: InstanceType<typeof Client>['fetch'] = defaultPool.fetch.bind(defaultPool);
 ...
 */
export async function fetchUsing(dialer: Dialer, input: string | Request | URL, opts?: RequestInit): Promise<Response> {
